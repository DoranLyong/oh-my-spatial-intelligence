...
> **arXiv**: 2605.05163v1 [cs.CV] 6 May 2026

---

![Figure 1|700](figs/physforge/figure_1.jpg)
...
> *(Source: Yang et al., 2026, arXiv:2605.05163)*
...
where $c$ is the condition from the VLM blueprint. The loss terms $\mathcal{L}_{geo}$ and $\mathcal{L}_{kine}$ are the standard $L_2$ losses between the predicted and target velocities for the geometry latents $Z_g$ and kinematic latents $Z_k$, respectively:
...
| Method | CD ↓ | F1-0.1 ↑ | F1-0.05 ↑ | Absolute scale (cm) ↓ | Material ↓ | Affordance ↓ | Description ↑ |
|---|---|---|---|---|---|---|---|
...
| Method | CD ↓ | F1-0.1 ↑ | F1-0.05 ↑ | Absolute scale (m) ↓ | Material ↓ | Function ↑ | Interaction ↑ |
|---|---|---|---|---|---|---|---|
...
**Kinematic Parameters.** In Table 4, we present the quantitative comparison between our method and the baseline models, along with qualitative results on the validation set (Figure 4) and on in-the-wild images (Figure 5). The articulated objects generated by our method are significantly superior to the baseline in terms of both consistency with the input image and the accuracy of the joint parameters.
...
To demonstrate the downstream utility of our generated assets, we showcase three primary applications in Figure 6:

- **(a) Robotic Simulation**: We demonstrate that our generated assets can be successfully imported into the **RoboTwin** (Mu et al., 2025; Chen et al., 2025c) simulation environment. The detailed part-level geometry and precise kinematic parameters allow robotic manipulators to realistically interact with the objects.
...
- **[1]** Alldieck, T., Kolotouros, N., and Sminchisescu, C. Score distillation sampling with learned manifold corrective. In ECCV, 2024.
...
- **[3]** Cao, Z., Chen, Z., Pan, L., and Liu, Z. Physx-3d: Physical-grounded 3d asset generation. arXiv preprint arXiv:2507.12465, 2025a.
- **[4]** Cao, Z., Hong, F., Chen, Z., Pan, L., and Liu, Z. Physxanything: Simulation-ready physical 3d assets from single image. arXiv preprint arXiv:2511.13648, 2025b.
- **[5]** Chen, J., Xu, Z., Pan, X., Hu, Y., Qin, C., Goldstein, T., Huang, L., Zhou, T., Xie, S., Savarese, S., et al. Blip3-o: A family of fully open unified multimodal models — architecture, training and dataset. arXiv preprint arXiv:2505.09568, 2025a.
- **[6]** Chen, M., Shapovalov, R., Laina, I., Monnier, T., Wang, J., Novotny, D., and Vedaldi, A. Partgen: Part-level 3d generation and reconstruction with multi-view diffusion models. arXiv preprint arXiv:2412.18608, 2024a.
- **[7]** Chen, M., Wang, J., Shapovalov, R., Monnier, T., Jung, H., Wang, D., Ranjan, R., Laina, I., and Vedaldi, A. Autopartgen: Autogressive 3d part generation and discovery. arXiv preprint arXiv:2507.13346, 2025b.
- **[8]** Chen, R., Chen, Y., Jiao, N., and Jia, K. Fantasia3d: Disentangling geometry and appearance for high-quality text-to-3d content creation. In ICCV, 2023.
- **[9]** Chen, T., Chen, Z., Chen, B., Cai, Z., Liu, Y., Li, Z., Liang, Q., Lin, X., Ge, Y., Gu, Z., et al. Robotwin 2.0: A scalable data generator and benchmark with strong domain randomization for robust bimanual robotic manipulation. arXiv preprint arXiv:2506.18088, 2025c.
- **[10]** Chen, Y., Wang, T., Wu, T., Pan, X., Jia, K., and Liu, Z. Comboverse: Compositional 3d assets creation using spatially-aware diffusion guidance. In ECCV, 2024b.
- **[11]** Chen, Z., Walsman, A., Memmel, M., Mo, K., Fang, A., Vemuri, K., Wu, A., Fox, D., and Gupta, A. Urdformer: A pipeline for constructing articulated simulation environments from real-world images. arXiv preprint arXiv:2405.11656, 2024c.
- **[12]** Deitke, M., Schwenk, D., Salvador, J., Weihs, L., Michel, O., VanderBilt, E., Schmidt, L., Ehsani, K., Kembhavi, A., and Farhadi, A. Objaverse: A universe of annotated 3d objects. In CVPR, 2023.
- **[13]** Ding, L., Dong, S., Li, Y., Gao, C., Chen, X., Han, R., Kuang, Y., Zhang, H., Huang, B., Huang, Z., et al. Fullpart: Generating each 3d part at full resolution. arXiv preprint arXiv:2510.26140, 2025.
- **[14]** Dong, S., Ding, L., Chen, X., Li, Y., Wang, Y., Wang, Y., Wang, Q., Kim, J., Gao, C., Huang, Z., et al. From one to more: Contextual part latents for 3d generation. In ICCV, 2025.
- **[15]** Gao, D., Siddiqui, Y., Li, L., and Dai, A. Meshart: Generating articulated meshes with structure-guided transformers. In CVPR, 2025.
- **[16]** He, X., Wu, Y., Guo, X., Ye, C., Zhou, J., Hu, T., Han, X., and Du, D. Unipart: Part-level 3d generation with unified 3d geom-seg latents. arXiv preprint arXiv:2512.09435, 2025.
- **[17]** Huang, Y., Wang, J., Shi, Y., Qi, X., Zha, Z.-J., and Zhang, L. Dreamtime: An improved optimization strategy for text-to-3d content creation. In ICLR, 2024a.
- **[18]** Huang, Z., Wen, H., Dong, J., Wang, Y., Li, Y., Chen, X., Cao, Y.-P., Liang, D., Qiao, Y., Dai, B., et al. Epidiff: Enhancing multi-view synthesis via localized epipolar-constrained diffusion. In CVPR, 2024b.
...
- **[20]** Lai, Z., Zhao, Y., Zhao, Z., Liu, H., Lin, Q., Huang, J., Guo, C., and Yue, X. Lattice: Democratize high-fidelity 3d generation at scale. arXiv preprint arXiv:2512.03052, 2025.
- **[21]** Le, L., Xie, J., Liang, W., Wang, H.-J., Yang, Y., Ma, Y. J., Vedder, K., Krishna, A., Jayaraman, D., and Eaton, E. Articulate-anything: Automatic modeling of articulated objects via a vision-language foundation model. arXiv preprint arXiv:2410.13882, 2024.
- **[22]** Li, S., Paschalidou, D., and Guibas, L. Pasta: Controllable part-aware shape generation with autoregressive transformers. arXiv preprint arXiv:2407.13677, 2024.
- **[23]** Li, Y., Zou, Z.-X., Liu, Z., Wang, D., Liang, Y., Yu, Z., Liu, X., Guo, Y.-C., Liang, D., Ouyang, W., et al. Triposg: High-fidelity 3d shape synthesis using large-scale rectified flow models. arXiv preprint arXiv:2502.06608, 2025.
- **[24]** Lian, X., Yu, Z., Liang, R., Wang, Y., Luo, L. R., Chen, K., Zhou, Y., Tang, Q., Xu, X., Lyu, Z., et al. Infinite mobility: Scalable high-fidelity synthesis of articulated objects via procedural generation. arXiv preprint arXiv:2503.13424, 2025.
- **[25]** Lin, C.-H., Gao, J., Tang, L., Takikawa, T., Zeng, X., Huang, X., Kreis, K., Fidler, S., Liu, M.-Y., and Lin, T.-Y. Magic3d: High-resolution text-to-3d content creation. In CVPR, 2023.
- **[26]** Lin, Y., Lin, C., Pan, P., Yan, H., Feng, Y., Mu, Y., and Fragkiadaki, K. Partcrafter: Structured 3d mesh generation via compositional latent diffusion transformers. arXiv preprint arXiv:2506.05573, 2025.
- **[27]** Lipman, Y., Chen, R. T., Ben-Hamu, H., Nickel, M., and Le, M. Flow matching for generative modeling. In NeurIPS, 2024.
- **[28]** Liu, A., Lin, C., Liu, Y., Long, X., Dou, Z., Guo, H.-X., Luo, P., and Wang, W. Part123: Part-aware 3d reconstruction from a single-view image. In ACM SIGGRAPH, 2024a.
- **[29]** Liu, F., Ye, J., Wang, Y., Wang, H., Wang, Z., Zhu, J., and Duan, Y. Dreamreward-x: Boosting high-quality 3d generation with human preference alignment. TPAMI, 2025a.
- **[30]** Liu, J., Mahdavi-Amiri, A., and Savva, M. Paris: Part-level reconstruction and motion analysis for articulated objects. In ICCV, 2023.
- **[31]** Liu, J., Iliash, D., Chang, A. X., Savva, M., and Mahdavi-Amiri, A. Singapo: Single image controlled generation of articulated parts in objects. arXiv preprint arXiv:2410.16499, 2024b.
- **[32]** Liu, J., Tam, H. I. I., Mahdavi-Amiri, A., and Savva, M. Cage: Controllable articulation generation. In CVPR, 2024c.
- **[33]** Liu, M., Shi, R., Chen, L., Zhang, Z., Xu, C., Wei, X., Chen, H., Zeng, C., Gu, J., and Su, H. One-2-3-45++: Fast single image to 3d objects with consistent multi-view generation and 3d diffusion. In CVPR, 2024d.
- **[34]** Liu, M., Uy, M. A., Xiang, D., Su, H., Fidler, S., Sharp, N., and Gao, J. Partfield: Learning 3d feature fields for part segmentation and beyond. arXiv preprint arXiv:2504.11451, 2025b.
- **[35]** Liu, Y., Lin, C., Zeng, Z., Long, X., Liu, L., Komura, T., and Wang, W. Syncdreamer: Learning to generate multiview-consistent images from a single-view image. In ICLR, 2024e.
- **[36]** Liu, Y., Jia, B., Lu, R., Ni, J., Zhu, S.-C., and Huang, S. Building interactable replicas of complex articulated objects via gaussian splatting. In ICLR, 2025c.
- **[37]** Long, X., Guo, Y.-C., Lin, C., Liu, Y., Dou, Z., Liu, L., Ma, Y., Zhang, S.-H., Habermann, M., Theobalt, C., et al. Wonder3d: Single image to 3d using cross-domain diffusion. In CVPR, 2024.
- **[38]** Mandi, Z., Weng, Y., Bauer, D., and Song, S. Real2code: Reconstruct articulated objects via code generation. arXiv preprint arXiv:2406.08474, 2024.
- **[39]** Metzer, G., Richardson, E., Patashnik, O., Giryes, R., and Cohen-Or, D. Latent-nerf for shape-guided generation of 3d shapes and textures. In CVPR, 2023.
- **[40]** Mo, K., Zhu, S., Chang, A. X., Yi, L., Tripathi, S., Guibas, L. J., and Su, H. Partnet: A large-scale benchmark for fine-grained and hierarchical part-level 3d object understanding. In CVPR, 2019.
- **[41]** Mu, Y., Chen, T., Chen, Z., Peng, S., Lan, Z., Gao, Z., Liang, Z., Yu, Q., Zou, Y., Xu, M., Lin, L., Xie, Z., Ding, M., and Luo, P. Robotwin: Dual-arm robot benchmark with generative digital twins. In CVPR, 2025.
- **[42]** Poole, B., Jain, A., Barron, J. T., and Mildenhall, B. Dreamfusion: Text-to-3d using 2d diffusion. In ICLR, 2023.
- **[43]** Qi, Z., Yang, Y., Zhang, M., Xing, L., Wu, X., Wu, T., Lin, D., Liu, X., Wang, J., and Zhao, H. Tailor3d: Customized 3d assets editing and generation with dual-side images. arXiv preprint arXiv:2407.06191, 2024.
- **[44]** Qiu, X., Yang, J., Wang, Y., Chen, Z., Wang, Y., Wang, T.-H., Xian, Z., and Gan, C. Articulate anymesh: Open-vocabulary 3d articulated objects modeling. arXiv preprint arXiv:2502.02590, 2025.
- **[45]** Shi, R., Chen, H., Zhang, Z., Liu, M., Xu, C., Wei, X., Chen, L., Zeng, C., and Su, H. Zero123++: A single image to consistent multi-view diffusion base model. arXiv preprint arXiv:2310.15110, 2023.
- **[46]** Song, C., Wei, J., Foo, C. S., Lin, G., and Liu, F. Reacto: Reconstructing articulated objects from a single video. In CVPR, 2024.
- **[47]** Sun, Q., Cui, Y., Zhang, X., Zhang, F., Yu, Q., Wang, Y., Rao, Y., Liu, J., Huang, T., and Wang, X. Generative multimodal models are in-context learners. In CVPR, 2024.
- **[48]** Tang, B., Wang, J., Wu, Z., and Zhang, L. Stable score distillation for high-quality 3d generation. arXiv preprint: 2312.09305, 2023.
- **[49]** Tang, J., Lu, R., Li, Z., Hao, Z., Li, X., Wei, F., Song, S., Zeng, G., Liu, M.-Y., and Lin, T.-Y. Efficient part-level 3d object generation via dual volume packing. arXiv preprint arXiv:2506.09980, 2025.
- **[50]** Tu, T., Li, M.-F., Lin, C. H., Cheng, Y.-C., Sun, M., and Yang, M.-H. Dreamo: Articulated 3d reconstruction from a single casual video. In WACV, 2025.
- **[51]** Wang, H., Du, X., Li, J., Yeh, R. A., and Shakhnarovich, G. Score jacobian chaining: Lifting pretrained 2d diffusion models for 3d generation. In CVPR, 2023a.
- **[52]** Wang, X., Wang, Y., Ye, J., Sun, F., Wang, Z., Wang, L., Liu, P., Sun, K., Wang, X., Xie, W., et al. Animatabledreamer: Text-guided non-rigid 3d model generation and reconstruction with canonical score distillation. In ECCV, 2024.
- **[53]** Wang, X., Liu, L., Cao, Y., Wu, R., Qin, W., Wang, D., Sui, W., and Su, Z. Embodiedgen: Towards a generative 3d world engine for embodied intelligence. arXiv preprint arXiv:2506.10600, 2025.
- **[54]** Wang, Z., Lu, C., Wang, Y., Bao, F., Li, C., Su, H., and Zhu, J. Prolificdreamer: High-fidelity and diverse text-to-3d generation with variational score distillation. In NeurIPS, 2023b.
- **[55]** Wen, H., Huang, Z., Wang, Y., Chen, X., and Sheng, L. Ouroboros3d: Image-to-3d generation via 3d-aware recursive diffusion. In CVPR, 2025.
- **[56]** Weng, Y., Wen, B., Tremblay, J., Blukis, V., Fox, D., Guibas, L., and Birchfield, S. Neural implicit representation for building digital twins of unknown articulated objects. In CVPR, 2024.
- **[57]** Wu, D., Liu, L., Linli, Z., Huang, A., Song, L., Yu, Q., Wu, Q., and Lu, C. Reartgs: Reconstructing and generating articulated objects via 3d gaussian splatting with geometric and motion constraints. arXiv preprint arXiv:2503.06677, 2025.
- **[58]** Wu, Z., Zhou, P., Yi, X., Yuan, X., and Zhang, H. Consistent3d: Towards consistent high-fidelity text-to-3d generation with deterministic sampling prior. In CVPR, 2024.
- **[59]** Xiang, F., Qin, Y., Mo, K., Xia, Y., Zhu, H., Liu, F., Liu, M., Jiang, H., Yuan, Y., Wang, H., et al. Sapien: A simulated part-based interactive environment. In CVPR, 2020.
- **[60]** Xiang, J., Lv, Z., Xu, S., Deng, Y., Wang, R., Zhang, B., Chen, D., Tong, X., and Yang, J. Structured 3d latents for scalable and versatile 3d generation. arXiv preprint arXiv:2412.01506, 2024.
- **[61]** Xu, J., Cheng, W., Gao, Y., Wang, X., Gao, S., and Shan, Y. Instantmesh: Efficient 3d mesh generation from a single image with sparse-view large reconstruction models. arXiv preprint arXiv:2404.07191, 2024.
- **[62]** Yan, H., Zhang, M., Li, Y., Ma, C., and Ji, P. Phycage: Physically plausible compositional 3d asset generation from a single image. arXiv preprint arXiv:2411.18548, 2024a.
- **[63]** Yan, J., Gao, Y., Yang, Q., Wei, X., Xie, X., Wu, A., and Zheng, W.-S. Dreamview: Injecting view-specific text guidance into text-to-3d generation. In ECCV, 2024b.
- **[64]** Yang, Y., Huang, Y., Guo, Y.-C., Lu, L., Wu, X., Lam, E. Y., Cao, Y.-P., and Liu, X. Sampart3d: Segment any part in 3d objects. arXiv preprint arXiv:2411.07184, 2024a.
- **[65]** Yang, Y., Huang, Y., Wu, X., Guo, Y.-C., Zhang, S.-H., Zhao, H., He, T., and Liu, X. DreamComposer: Controllable 3D Object Generation via Multi-View Conditions. In CVPR, 2024b.
- **[66]** Yang, Y., Zhou, Y., Guo, Y.-C., Zou, Z.-X., Huang, Y., Liu, Y.-T., Xu, H., Liang, D., Cao, Y.-P., and Liu, X. Omnipart: Part-aware 3d generation with semantic decoupling and structural cohesion. arXiv preprint arXiv:2507.06165, 2025.
- **[67]** Ye, J., Liu, F., Li, Q., Wang, Z., Wang, Y., Wang, X., Duan, Y., and Zhu, J. Dreamreward: Text-to-3d generation with human preference. In ECCV, 2024.
- **[68]** Yi, T., Fang, J., Wu, G., Xie, L., Zhang, X., Liu, W., Tian, Q., and Wang, X. Gaussiandreamer: Fast generation from text to 3d gaussian splatting with point cloud priors. In CVPR, 2024.
- **[69]** Zhan, X., Yang, L., Zhao, Y., Mao, K., Xu, H., Lin, Z., Li, K., and Lu, C. Oakink2: A dataset of bimanual hands-object manipulation in complex task completion. In CVPR, 2024.
- **[70]** Zhang, B., Tang, J., Niessner, M., and Wonka, P. 3dshape2vecset: A 3d shape representation for neural fields and generative diffusion models. ACM Transactions On Graphics (TOG), 42(4):1–16, 2023.
- **[71]** Zhang, L., Wang, Z., Zhang, Q., Qiu, Q., Pang, A., Jiang, H., Yang, W., Xu, L., and Yu, J. Clay: A controllable large-scale generative model for creating high-quality 3d assets. ACM Transactions on Graphics (TOG), 43(4):1–20, 2024.
- **[72]** Zhao, Z., Liu, W., Chen, X., Zeng, X., Wang, R., Cheng, P., Fu, B., Chen, T., Yu, G., and Gao, S. Michelangelo: Conditional 3d shape generation based on shape-image-text aligned latent representation. NeurIPS, 2023.
- **[73]** Zou, Z.-X., Yu, Z., Guo, Y.-C., Li, Y., Liang, D., Cao, Y.-P., and Zhang, S.-H. Triplane meets gaussian splatting: Fast and generalizable single-view 3D reconstruction with transformers. arXiv preprint, 2024.
